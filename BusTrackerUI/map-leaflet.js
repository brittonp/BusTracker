    ...
    create: function (mapID, center) {
        ...
        this.map.on('moveend', function (e) {
                if (thisObj.currentViewMode == appConstant.viewMode.search) {
                    $(e.target._container).trigger('map-move');
                }
    ...
    addVehicles: async function (vehicles) {
        ...
        $.each(vehicles, function (index, vehicle) {
            ...
            const icon = new L.DivIcon({
                ...
                iconSize: null,
                html: `<div class="bt-marker-vehicle bus-direction-${vehicle.extendedAttributes.directionCode} ${favourite} ${aged}" style="--dir: ${Number(vehicle.MonitoredVehicleJourney.Bearing)}"><div class="route">
    ...
    addTrackedVehicle: async function (vehicle) {
        ...
        if (this.markers.length > 1) {
            ...
            const polyline = L.polyline([
                ...
                .addTo(this.map);
            this.annotations.push(polyline);
            ...
            this.annotations.push(polylineDecorator);
            ...
            const speedMarker = L.marker(speedMarkerPos, {
                ...
                .setIcon(speedTag)
                .addTo(this.map);
            this.annotations.push(speedMarker);
        }
        ...
        this.map.flyTo(position, (this.markers.length > 1) ? this.getZoom() : appConstant.defaultZoom);
    },
