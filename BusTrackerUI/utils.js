...
export const appUtils = {
    ...
    velocityBetweenPoints: function (point1, point2) {
        ...
        const tHours = (new Date(point2.timestamp) - new Date(point1.timestamp)) / (1000 * 60 * 60);
    ...
    BTMessage: function (options = null) {
        ...
        if (options.actions) {
            ...
            options.actions.forEach((a) => {
                ...
                $(el)
                    .on('click', `.ui.${a.className}.button`, (e) => {
                        a.action();
                        this.hide();
                    })
            });
        ...
        el.innerHTML = `<div class="box">
            ...
            <div class="right row">
                <div class="actions">
                    ${options.closeAction ? '<div class="ui close button">Close</div>' : ''}
                    ${actions}
                </div>                
            </div>
        </div>`;
